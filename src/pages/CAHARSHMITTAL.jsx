...
export default function CAHARSHMITTAL() {
    ...
    <div style={styles.page}>
      ...
      <div style={styles.header}>
        <div style={styles.headerTop}>
          <div>
            <h1 style={styles.heading}>CA HARSH MITTAL</h1>
      ...
      <div style={styles.grid}>
        ...
        <div
          style={styles.card}
          onClick={() => navigate("/daharshmittal")}
        >
        ...
        <div
          style={styles.card}
          onClick={() => navigate("/daily-working-harsh-mittal")}
        >
