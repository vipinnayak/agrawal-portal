...
function DaAdityaRaj() {
  ...
  useEffect(() => {
    ...
    fetch(
      "https://script.google.com/macros/s/AKfycbwD8ccE7z2SoZlZczMRM8VotkufQCF6WHmIfv_IH69UaFQQhjFtp6A-szNJgM7RTRTNGQ/exec"
    )
