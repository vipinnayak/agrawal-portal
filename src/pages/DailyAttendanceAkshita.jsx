...
function DailyAttendanceAkshita() {
  ...
  useEffect(() => {
    fetch(
      "https://script.google.com/macros/s/AKfycbz1ck4qaw9lxbha02gMBc2C-JflpdFNMUI6X-fA8hHnfyZATnk9qYSp4WN9I4u1r8c6lg/exec"
    )
      .then((res) => res.json())
      .then((data) => {
        console.log(data);
...
export default DailyAttendanceAkshita;