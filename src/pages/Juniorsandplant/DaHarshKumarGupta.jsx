...
function DaHarshKumarGupta() {
  ...
  useEffect(() => {
    fetch(
      "https://script.google.com/macros/s/AKfycbyxeQflJUfWCVVYkO9lxLbFQW_KDGqrIbJ46ID6LfVxpkN5uG5URppsn--fskIIhKpKxA/exec"
    )
      .then((res) => res.json())
      .then((data) => {
        console.log(data);
...
export default DaHarshKumarGupta;