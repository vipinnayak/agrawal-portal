...
function DaNayanpreetSaluja() {
  ...
  useEffect(() => {
    fetch(
      "https://script.google.com/macros/s/AKfycbzaOC1HeBPiEWZ25ElU0Clh-BNMnYfM_kxDAPpcQq9MvbKgV4-qpIrnazE-A31EgkjJ2w/exec"
    )
      .then((res) => res.json())
      .then((data) => {
        console.log(data);
...
export default DaNayanpreetSaluja;