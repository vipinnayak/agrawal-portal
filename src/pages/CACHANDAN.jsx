...
export default function CACHANDAN() {
    ...
    <div style={styles.page}>
      ...
      <div style={styles.header}>
        <div style={styles.headerTop}>
          <div>
            <h1 style={styles.heading}>CA CHANDAN</h1>
      ...
      <div style={styles.grid}>
        ...
        <div
          style={styles.card}
          onClick={() => navigate("/daily-working-chandan")}
        >
      ...
      <div
          style={styles.card}
          onClick={() => navigate("/cdchandansingh")}
        >
