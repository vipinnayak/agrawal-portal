...
export default function CAPANKAJ() {
    ...
    <div style={styles.page}>
      ...
      <div style={styles.header}>
        <div style={styles.headerTop}>
          <div>
            <h1 style={styles.heading}>CA PANKAJ AGRAWAL</h1>
      ...
      <div style={styles.grid}>
        ...
        <div
          style={styles.card}
          onClick={() => navigate("/daily-working-pankaj")}
        >
        ...
        <div
          style={styles.card}
          onClick={() => navigate("/cdpankajagrawal")}
        >
