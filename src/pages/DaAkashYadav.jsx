...
function DaAkashYadav() {
  ...
  useEffect(() => {
    fetch(
      "https://script.google.com/macros/s/AKfycbzJNXoowcl4Nm9H2R_CoYQDX9kRV-o6B5blxL09zAMaxY5oGWZ88j-8asIifePnQjJe/exec"
    )
      .then((res) => res.json())
      .then((data) => {
        console.log(data);
