...
function DailyAttendanceManviRoy() {
  ...
  useEffect(() => {
    fetch(
      "https://script.google.com/macros/s/AKfycbz6hWVagcZ31vX9QFOb5dm6Kc7RWNNfMI16KifIpVVu0TogfWDsYGOM8jZ-r8FDaGl9Wg/exec"
    )
      .then((res) => res.json())
      .then((data) => {
        console.log(data);
...
export default DailyAttendanceManviRoy;