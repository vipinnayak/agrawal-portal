...
function DaAnkitSingh() {
  ...
  useEffect(() => {
    fetch(
      "https://script.google.com/macros/s/AKfycbzzhLxVahm_ed-iUkhebBDGsWEax8wlhtMw9Is7K6LVwO2Dd4lN4BjEyB5gM3YvtKC6SA/exec"
    )
      .then((res) => res.json())
      .then((data) => {
        console.log(data);
