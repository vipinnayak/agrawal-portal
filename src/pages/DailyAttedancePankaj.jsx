...
function DailyAttendancePankaj() {
  ...
  useEffect(() => {
    fetch(
      "https://script.google.com/macros/s/AKfycbwvQwEjIW92lJYrnKTlhU7aGIpLxQIzlx1VYP06i-j3dQYlhdnldySAI-on-txqIdTUuw/exec"
    )
      .then((res) => res.json())
      .then((data) => {
        console.log(data);
...
export default DailyAttendancePankaj;