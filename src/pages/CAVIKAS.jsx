...
export default function CAVIKAS() {
    ...
    <div style={styles.page}>
      ...
      <div style={styles.header}>
        <div style={styles.headerTop}>
          <div>
            <h1 style={styles.heading}>CA VIKAS</h1>
      ...
      <div style={styles.grid}>
        ...
        <div
          style={styles.card}
          onClick={() => navigate("/daily-working-Vikas")}
        >
